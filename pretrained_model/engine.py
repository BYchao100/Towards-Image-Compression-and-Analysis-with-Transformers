...
def evaluate(data_loader, model, device, output_dir):
    ...
    # gather the stats from all processes
    metric_logger.synchronize_between_processes()
    print('* Acc@1 {top1.global_avg:.3f} Acc@5 {top5.global_avg:.3f} loss_cls {losses_cls.global_avg:.3f} loss_rec {losses_rec.global_avg:.3f} psnr {psnr.global_avg:.3f}'
          .format(top1=metric_logger.acc1, top5=metric_logger.acc5, losses_cls=metric_logger.loss_cls, losses_rec=metric_logger.loss_rec, psnr=metric_logger.psnr))
